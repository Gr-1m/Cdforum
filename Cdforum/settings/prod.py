...
# python manage.py runserver --settings=Cdforum.settings.prod_local
...
SECRET_KEY = os.environ.get("SECRET_KEY", 'django-insecure-%5)u@x8yg6uwfet!=03141#zx#^wc0bz=mt2&4aiz)an0t+916')
